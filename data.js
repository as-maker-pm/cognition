...
window.MOCK_DETAIL = {
  ...
  sentiment: [
    { t: 0,   v: 0.2,  label: 'Introduction' },
    { t: 60,  v: 0.3,  label: 'Background' },
    { t: 120, v: 0.1,  label: 'June 3rd Events' },
    { t: 150, v: -0.3, label: '2PM Meeting' },
    { t: 180, v: 0,    label: '' },
    { t: 240, v: 0.2,  label: '' },
    { t: 300, v: -0.1, label: 'Contract Terms' },
    { t: 330, v: -0.6, label: 'Defensive' },
    { t: 360, v: -0.4, label: '' },
    { t: 420, v: 0.1,  label: 'Financial' },
    { t: 480, v: 0.3,  label: 'Closing' },
  ],
  timeline: [
    { id: 'ev1', date: '2023-01-15', time: '10:00 AM',          title: 'Employment Contract Signed', description: 'Sarah Chen signed employment agreement with TechCorp as Senior Project Manager', category: 'document', contradiction: false },
    { id: 'ev2', date: '2024-06-03', time: '9:00 AM',           title: 'Arrived at Office',          description: 'Witness testified arriving at office around 9 AM',                                  category: 'action',   contradiction: true,  contradictionDetails: 'Badge scan (Exhibit E) shows entry at 9:03 AM; witness later mentions arriving "closer to 9:15".' },
    { id: 'ev3', date: '2024-06-03', time: '9:30 AM',           title: 'Team Standup Meeting',       description: 'Regular team standup',                                                              category: 'meeting',  contradiction: false },
    { id: 'ev4', date: '2024-06-03', time: '9:45 AM – 12:00 PM',title: 'Worked on Quarterly Report', description: 'Q2 2024 quarterly report until lunch',                                              category: 'action',   contradiction: false },
    { id: 'ev5', date: '2024-06-03', time: '2:00 PM',           title: '2PM Meeting Scheduled',      description: 'Meeting scheduled to start at 2:00 PM per email',                                   category: 'meeting',  contradiction: true,  contradictionDetails: 'Email (Exhibit B) shows 2:00 PM scheduled; minutes (Exhibit C) show start at 2:15 PM, witness confirms "around 2:15".' },
